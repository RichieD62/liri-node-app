...
function movieThis(movieName){
	...
	request("https://api.themoviedb.org/3/search/movie?api_key=dec2caeb&query=" + movieName, function(error, response, body) {
  	...
  	if (!error && response.statusCode === 200) {
	    ...
	    var queryURL = "https://api.themoviedb.org/3/movie/" + movieID + "?api_key=dec2caeb&append_to_response=credits,releases";
